...
function FeaturedPost(props) {
  ...
  const deleteDetails = async (id) => {
    ...
    await axios.delete(
      "https://car-rentalsystem-backend.herokuapp.com/api/v1/employee/deleteemployee/" +
        id
    );
          ...
          <Card className={classes.card}>
            <div className={classes.cardDetails}>
              <Link
                ...
                to={{ pathname: "/userprofile", data: { empData: emp } }}
              >
                <CardContent>
